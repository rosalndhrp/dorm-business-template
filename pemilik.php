...
<html lang="en">
 ...
 <div class="mx-auto" style="width: 400px;">
  ...
  <div class="card-body">
    <h5 class="card-title">Silahkan Isi Data Anda</h5>
    <p class="card-text">
      <form action="loginpemilik.php" method="POST">
        

  <div class="form-group">
    <label for="exampleInputEmail1">Username</label>
    <input required name="username" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Username">
...
<?php
  ...
  <div class="card-footer text-muted">
     Belum punya akun ? |  <a href="daftarpemilik.php" class="badge badge-primary">Daftar</a>
  </div>
</div>
</div>
