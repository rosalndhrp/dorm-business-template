...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="http://localhost/Juragankost">Beranda <span class="sr-only">(current)</span></a>
      </li>
  ...
  <br>
   ...
   <br>
    ...
    <?php
      $kota = $_GET['kota'];
      $sql = "SELECT * FROM kos WHERE kota ='$kota'";
      ...
      <div class="card" style="width: 18rem;">
        <img src="http://localhost/Juragankost/gambar/medan.jpg" class="card-img-top" alt="">
        <div class="card-body">
