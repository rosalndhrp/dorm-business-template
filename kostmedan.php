...
<html lang="en">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="#">Sebagai Pencari</a>
 ...
 <div class="container">
  <p>
  <a class="btn btn-primary" data-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Kampus berdasarkan kota</a>
...
<div class="row">
  <div class="col">
    ...
    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" >
      <a class="dropdown-item" href="#">UINSU</a>
      <a class="dropdown-item" href="#">UNIMED</a>
      <a class="dropdown-item" href="#">UMSU</a>
